#!/usr/bin/env python3
"""
STR (Scene Text Recognition) Evaluation Script for LMDB datasets using DeepSeek-VL2
...
class DeepSeekVL2STREvaluator:
    ...
    def predict_text(self, image: Image.Image) -> str:
        """Generate text prediction for given image using DeepSeek-VL2"""
        try:
            ...
            # For PIL Image objects, we don't need to load them again
            pil_images = [image]
    ...
    def predict_batch(self, images: list) -> list:
        """Generate text predictions for multiple images using batch processing"""
        if not images:
            return []
        
        # For DeepSeek-VL2, we'll process images individually for now
        # since the batch processing approach differs from Qwen3-VL
        results = []
        for image in images:
    ...
    def print_results(self, results: dict):
        ...
        print("="*50)
        print("DEEPSEEK-VL2 STR EVALUATION RESULTS")
        print("="*50)
    ...
    def save_detailed_results(self, results: dict, output_file: str):
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            # Header
            f.write("="*100 + "\n")
            f.write("DeepSeek-VL2 STR Evaluation Results\n")
            f.write("="*100 + "\n")
...
def main():
    parser = argparse.ArgumentParser(description='STR Evaluation for LMDB datasets using DeepSeek-VL2')
    ...
    if lmdb_paths:
        print("Starting DeepSeek-VL2 STR Benchmark Evaluation")
        ...
        print("Loading model...")
        evaluator = DeepSeekVL2STREvaluator(
        ...
        with open(summary_file, 'w', encoding='utf-8') as f:
            f.write("DeepSeek-VL2 STR OCR Evaluation Summary\n")
            f.write("=" * 50 + "\n\n")
        ...
        print("=" * 50)
        print("DEEPSEEK-VL2 STR BENCHMARK EVALUATION COMPLETED")
        print("=" * 50)
        ...
        if not args.output_file:
            ...
            args.output_file = f"deepseek_vl2_str_results_{dataset_name}_{model_name_clean}.txt"
